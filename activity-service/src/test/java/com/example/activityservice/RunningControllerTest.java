...
//                        requestFields(
//                                fieldWithPath("createdTime").type(JsonFieldType.STRING).description("러닝 시작 시간"),
...
//        };
//        //when
//        mockMvc.perform(get("/running/week")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .accept(MediaType.APPLICATION_JSON)
//                        .param("id", String.valueOf(userId))
//                        .header("Authorization", "Bearer AccessToken"))
...
//                        preprocessRequest(prettyPrint()),
//                        preprocessResponse(prettyPrint()),
//                        responseFields(fieldWithPath("[]").description("running")).andWithPrefix("[].", running)));
//    }
//
//    @Test
...
//        };
//        //when
//        mockMvc.perform(get("/running/today")
//                        .contentType(MediaType.APPLICATION_JSON)
//                        .accept(MediaType.APPLICATION_JSON)
//                        .param("id", String.valueOf(userId))
//                        .header("Authorization", "Bearer AccessToken"))
