...
class GuestBookControllerTest {
        ...
        mockMvc.perform(post("/guest-book")
                ...
                .andDo(document("방명록 작성",
                        ResourceSnippetParameters.builder()
                                ...
                                .summary("")
                                .description("방명록 작성")
                                .requestSchema(Schema.schema("Request.CreateGuestBook")),
    ...
    void 방명록_전체_조회() throws Exception{
        ...
        //when
        mockMvc.perform(get("/guest-book/{userId}?page=0&size=5", userId, requestParameters(
    ...
    void 안읽은_방명록_조회() throws Exception{
        ...
        //when
        mockMvc.perform(get("/guest-book/unread/{userId}?page=0&size=5", userId, requestParameters(
                        parameterWithName("page").description("현재 페이지"),
                        parameterWithName("size").description("받아올 객체 개수")))
                        .contentType(MediaType.APPLICATION_JSON)
                        .accept(MediaType.APPLICATION_JSON)
